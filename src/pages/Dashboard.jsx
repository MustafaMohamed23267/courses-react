...
const buttonstyle = "rounded-full px-6 py-4 max-sm:px-4 max-sm:py-2 bg-teal-900 dark:bg-gray-900/70 flex text-white hover:scale-[1.05] duration-500 cursor-pointer dark:inset-shadow-sm inset-shadow-indigo-500 ";
...
<div className='fixed bg-black/70 w-full h-full top-0 z-5'></div>
         ...
         <div  className=' pt-15 w-full h-full z-10'>
            ...
            <main className='flex z-10 max-sm:flex-col max-sm:space-y-6 max-sm:items-center'>

                {/* left section */}
              <section className='md:w-[20%] px-5 flex md:flex-col space-y-2 z-10 max-sm:space-x-4 '>
                 <Link to='#' className={`${buttonstyle} space-x-2 border-l border-indigo-600`}> 
                <img src={dashboard} className={"w-6 h-6 max-sm:w-8 max-sm:h-8"} /> 
                ...
                <img src={add2} className={"md:w-5 md:fill-white max-sm:w-6 max-sm:h-6"} />
